...
def analisar_com_ia(dados_simulacao: Dict) -> Dict:
    ...
    try:
        ...
        if openai.api_key and openai.api_key != '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':
            try:
